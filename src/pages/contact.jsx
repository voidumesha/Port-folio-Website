      ...
      <div className=" shadow-md flex flex-row md:flex-col md:gap-8 bg-white dark:bg-gray-900 py-24 md:py-5 w-[70vw] md:w-[90vw] rounded-md">
        <div className='flex flex-col w-[49vw] md:w-full items-center justify-center gap-10'>
          ...
          <div>
            ...
            <p className='text-left text-gray-500 dark:text-gray-400'>I am available for ,
              <hr className="my-6 border-t-2 border-blue-400 dark:border-blue-600 w-full" />
              <div className="mb-8 flex flex-col items-start">
                <span className="text-2xl font-extrabold text-gray-700 dark:text-gray-200 mb-2 text-left border-2 border-blue-400 dark:border-blue-600 rounded-lg px-4 py-2 shadow-sm bg-white dark:bg-gray-800 transition-all duration-200 hover:scale-105">Mobile App development</span>
                <span className="text-2xl font-extrabold text-gray-700 dark:text-gray-200 mb-2 text-left border-2 border-blue-400 dark:border-blue-600 rounded-lg px-4 py-2 shadow-sm bg-white dark:bg-gray-800 transition-all duration-200 hover:scale-105">Embedded system development</span>
                <span className="text-2xl font-extrabold text-gray-700 dark:text-gray-200 mb-2 text-left border-2 border-blue-400 dark:border-blue-600 rounded-lg px-4 py-2 shadow-sm bg-white dark:bg-gray-800 transition-all duration-200 hover:scale-105">Website development</span>
                <span className="text-2xl font-extrabold text-gray-700 dark:text-gray-200 text-left border-2 border-blue-400 dark:border-blue-600 rounded-lg px-4 py-2 shadow-sm bg-white dark:bg-gray-800 transition-all duration-200 hover:scale-105">Ai tools creating</span>
              </div>
               Connect with me via social media or email.</p>
          </div>
        </div>
        <div className='flex w-[50vw] md:w-full items-center justify-center'>
          <form className='flex gap-5 flex-col w-[60%] md:w-[80%]' onSubmit={(e) => e.preventDefault()}>
            <input type="text" placeholder="Name" className="w-full p-3 border-2 border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-lg focus:outline-none focus:b</div>order-blue-500" />
