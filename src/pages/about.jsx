    ...
    <div className="h-[115vh] flex justify-center items-center dark:bg-black mt-12" id="about">
      <div className="flex flex-col justify-center bg-white dark:bg-gray-900 p-[2.5rem] md:p-[2rem] rounded-lg shadow-lg w-[70vw] md:w-[85vw] min-h-[50vh]">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex dark:text-gray-400 items-center gap-2 mt-200 min-h-[2.5rem]"> 
            <HiCodeBracket />
            <span>
              <Typewriter
          ...
          <p className="flex dark:text-gray-400 items-center gap-2"> <GoLocation /> Colombo, Sri Lanka </p>
          <p className="leading-relaxed text-gray-600 dark:text-gray-300 text-justify text-sm">
            Experienced Software Developer with a keen eye for detail and a focus on dynamic solutions. Proficient in multiple programming languages such as Flutter, 
            ...
            student from the Faculty of Technology, Department of Information and Communication Technology, at Rajarata University of Sri Lanka, achieving a BICT (Hons) Degree. Currently I am working as a mobile App Developer at Flightloop Pty Ltd - Australia.
          </p>
          <div className="flex gap-3 md:justify-around">
            ...
            <button className="flex gap-2 items-center rounded-full bg-blue-600 dark:bg-blue-800 px-3 py-2 w-fit text-sm text-white dark:text-gray-300 md:place-self-center hover:bg-blue-900"
              onClick={() =>{
                ...
                link.href = 'https://drive.google.com/file/d/1-SNj3km-EOcVgrql2QKcDehbbY4WDjaa/view?usp=sharing';
                link.target = '_blank';
                link.click();
              }}
            >
